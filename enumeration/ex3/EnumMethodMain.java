...
public class EnumMethodMain {
    ...
    public static void main(String[] args) {
        ...
        for (Grade value : values){
            System.out.println("nume : " + value.name() + ",ordinal = " + value.ordinal());
        }

        // String -> Enum 변환
        String input = "GOLD";
        Grade grade = Grade.valueOf(input);
        System.out.println("grade = " + grade); // toString() 오버라이딩 기능

        /*
        1. Arrays. toString() : 배열의 참조값이 아니라 배열 내부의 값을 출력할 때 사용
        2. values() : 모든 enum 상수를 포함하여 배열을 반환한다.
        ...
        주의 - ordinal()은 가급적으로 사용하지 않는 것이 좋다.
         */
    }
}
/*
    모든 열거형은 java.lang.Enum 클래스를 자동으로 상송받는다.
