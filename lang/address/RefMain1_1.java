...
/*
    ...
    b = a 라고 하면 a에 잇는 참조값(주소값)이 x001을 복사해서 b에 전달한다.
    ...
    이렇게 주된 작업 외에 추가적인 보수 효과를 일으키는 것을 사이드 이팩트라고 한다.
    프로그래밍에 사이트 이펙트는 보통 부정적인 의미로 사용되는데,
    사이드 이팩트는 프로그램의 특징 부분에서 발생한 변경이 의도치 않게 다른 부분에 영향을 미치기 때문이다.
